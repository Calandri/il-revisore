...
down_revision: str | None = "add_review_checkpoints"
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_database_connections_favorite", "database_connections", ["is_favorite"], unique=False
    )
    op.create_index("idx_database_connections_name", "database_connections", ["name"], unique=False)
    op.create_index(
        "idx_database_connections_type", "database_connections", ["db_type"], unique=False
    )
    op.create_index(
        op.f("ix_database_connections_deleted_at"),
        "database_connections",
        ["deleted_at"],
        unique=False,
    )

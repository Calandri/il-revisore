#!/usr/bin/env python3
"""
Il Revisore - Orchestrates AI agents to analyze and review code repositories.
...
def main():
    parser = argparse.ArgumentParser(
        description="🔍 Il Revisore - Analyze repository with AI agents",
...
Examples:
    ...
    print("=" * 60)
    print("\n🤖 Agents:")
    print("   - Gemini Flash → Repository Analysis")
    print("   - Claude Opus  → Code Review")
    print("=" * 60)
    ...
    # Run Flash Analyzer (Gemini)
    if not args.skip_flash and gemini_client:
        run_flash_analyzer(gemini_client, repo_path, output_dir)

    # Run Reviewers (Claude Opus)
    ...
    print(f"   📄 REPO_DESCRIPTION.md - Repository overview (Gemini Flash)")

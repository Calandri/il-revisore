"""Gemini conversational session for multi-turn interactions.

Uses context prepending since Gemini CLI doesn't support native session resume.
"""
...
if TYPE_CHECKING:
    ...
    from .models import GeminiCLIResult


class GeminiSession:
    """Multi-turn conversation session for Gemini CLI.

    Since Gemini CLI doesn't support native session resume, this implementation
    ...
    def __init__(
        ...
        Args:
            cli: The GeminiCLI instance to use.
